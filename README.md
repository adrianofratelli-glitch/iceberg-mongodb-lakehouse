...
the row takes to appear in Iceberg.

![The CDC cycle panel showing the order in MongoDB and the same row reflected in Iceberg](docs/screenshots/02-ciclo-cdc.png)
